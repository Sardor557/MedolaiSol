...
namespace Medolai.Shared.Extensions
{
    public interface IMyHttpContextAccessorExtensions
    {
        bool IsRoleAdmin();
    ...
    public class MyHttpContextAccessorExtensions : IMyHttpContextAccessorExtensions
    {
        private readonly IHttpContextAccessor accessor;

        public MyHttpContextAccessorExtensions(IHttpContextAccessor accessor)
        {
